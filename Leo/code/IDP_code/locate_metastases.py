...
for metastasis in metastases_in_patch515:
    print('ID: ' + str(metastasis['id']) + '\tVolume: ' + str(metastasis['volume']) + '\tLocation: ' + str(metastasis['offset']))
print("\nIn total, there are " + str(len(metastases_in_patch515)) + " metastases in patch 515")
...
for metastasis in metastases_in_patch515:
    # y_offset = metastasis['offset'][0] + metastasis['CoM'][0]
    x_offset = metastasis['offset'][1] + metastasis['CoM'][1]
    z_offset = metastasis['offset'][2] + metastasis['CoM'][2]
    plt.annotate('Here',xy=(z_offset,x_offset), xycoords='data',
                 xytext=(25,325), textcoords='data',
                 arrowprops=dict(arrowstyle='->',color='white'), color='white')

plt.imshow(MIP_y, vmin=0,vmax=500)
plt.title('MIP along y-axis, adj. contrast, all labelled metastases')
...
plt.imshow(MIP_x)
plt.title('MIP along x-axis, adj. contrast, all labelled metastases')
...
plt.imshow(MIP_z)
plt.title('MIP along z-axis, adj. contrast, all labelled metastases')
