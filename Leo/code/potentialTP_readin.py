...
def crop_ROI(metastasis, channel):
    ...
    ROI, zone = cropping.crop_ROI(patch_ID, met_location, met_absolute_location, ROI_width, channel) 
    return ROI


def write_ROI_to_Nifti():
...
for mouse in mice:
    ...
    for potential_TP_met in potential_TPs:
        for channel in channels:
            ROI = crop_ROI(potential_TP_met, channel)
